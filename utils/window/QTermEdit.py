...
from utils.window.Cursor_Manager import Cursor_Manager
from utils.window.event_handler import event_filter
from utils.window.prompt import load as pt
...
class QTermEdit(QTextEdit):
    def __init__(self, parent=None):
        ...
        self.event_handler = event_filter
        self.prompt = pt
        ...
        prompt = self.prompt(sets["Background"], "normal")
